...
ax.set_xlabel("weeks after the spend"); ax.set_ylabel("fraction of effect still active")
...
ax.set_title("ADSTOCK smooths bursts into sustained pressure")
ax.set_xlabel("week"); ax.set_ylabel("spend / effective pressure")
ax.legend(fontsize=8); ax.grid(alpha=0.3)
...
ax.set_title("Geometric vs Delayed Adstock")
ax.set_xlabel("lag"); ax.set_ylabel("adstock")
ax.legend(fontsize=8); ax.grid(alpha=0.3)
...
ax.set_title("SATURATION: diminishing returns (Hill curve)")
ax.set_xlabel("(adstocked) spend"); ax.set_ylabel("response (0 to 1)")
...
ax.set_title("MARGINAL return falls as spend rises")
ax.set_xlabel("(adstocked) spend"); ax.set_ylabel("extra response per extra $")
ax.legend(fontsize=8); ax.grid(alpha=0.3)
